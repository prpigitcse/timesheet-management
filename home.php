...
<?php
    $uid=$_SESSION['uid'];
    $conn = connectionDB();
    $result = selectFilesUsingUserid($conn, $uid);
?>
...
<body>
    ...
    <div class="home_filter">Select the month:
    ...
    <div class="user_home_body_display">
        <div class="card col-md-8 mt-5 table_card">
        ...
        <div class="container" style="margin: 0;">
            <h2>User Details</h2>
            <div class="card userdetail_card" style="width: auto;margin-top: 0px;">
                <?php
                    $result1 = selectUser($uid,$conn);
